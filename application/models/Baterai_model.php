...
class Baterai_model extends CI_Model
{
  ...
  public function __construct()
    ...
    public function chartBarangMasuk($bulan)
    {
        ...
        return count($this->db->get('brgmsk_btr')->result_array());
    }
    ...
    public function chartBarangKeluar($bulan)
    {
        ...
        return count($this->db->get('brgklr_btr')->result_array());
    }
     ...
     public function get_barcode_by_id($id = 0)
    {
        if ($id === 0)
        {
            $query = $this->db->get('master_baterai');
            return $query->result_array();
        }
 
        $query = $this->db->get_where('master_baterai', array('kode_brg' => $id));
    ...
    public function delete_brg($id)
    {
        ...
        return $this->db->delete('master_baterai');
    }
    ...
    public function get_brgmsk_by_id($id = 0)
    {
        if ($id === 0)
        {
            $query = $this->db->get('brgmsk_btr');
            return $query->result_array();
        }
 
        $query = $this->db->get_where('brgmsk_btr', array('id_barang_masuk' => $id));
        return $query->row_array();
    }
    ...
    public function delete_brgmsk($id)
    {
        ...
        return $this->db->delete('brgmsk_btr');
    }
    ...
    public function get_brgklr_by_id($id = 0)
    {
        if ($id === 0)
        {
            $query = $this->db->get('brgklr_btr');
            return $query->result_array();
        }
 
        $query = $this->db->get_where('brgklr_btr', array('id_barang_keluar' => $id));
        return $query->row_array();
    }
    ...
    public function delete_brgklr($id)
    {
        ...
        return $this->db->delete('brgklr_btr');
    }
    ...
    public function getBarang()
    {
        ...
        return $this->db->get('master_baterai ')->result_array();
    }
    ...
    public function getBarangMasuk($limit = null, $kode_brg = null, $range = null)
    {
        ...
        $this->db->join('master_baterai b', 'bm.barang_id = b.kode_brg');
        ...
        return $this->db->get('brgmsk_btr bm')->result_array();
    }
    ...
    public function getBarangKeluar($limit = null, $kode_brg = null, $range = null)
    {
        ...
        $this->db->join('master_baterai b', 'bk.barang_id = b.kode_brg');
        ...
        return $this->db->get('brgklr_btr bk')->result_array();
    }
