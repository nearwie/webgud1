...
class Regulator_model extends CI_Model
{
  ...
  public function __construct()
     ...
     public function get_barcode_by_id($id = 0)
    {
        if ($id === 0)
        {
            $query = $this->db->get('master_regulator');
    ...
    public function delete_brg($id)
    {
        ...
        return $this->db->delete('master_regulator');
    }
...
public function get_barang_by_id($kode_brg=0)
    ...
    public function getBarang()
    {
        ...
        return $this->db->get('master_regulator ')->result_array();
    }
    ...
    public function getBarangMasuk($limit = null, $kode_brg = null, $range = null)
    {
        ...
        $this->db->join('master_regulator b', 'bm.barang_id = b.kode_brg');
        ...
        return $this->db->get('brg_msk bm')->result_array();
    }
    ...
    public function getBarangKeluar($limit = null, $kode_brg = null, $range = null)
    {
        ...
        $this->db->join('master_regulator b', 'bk.barang_id = b.kode_brg');
        ...
        return $this->db->get('brg_klr bk')->result_array();
    }
