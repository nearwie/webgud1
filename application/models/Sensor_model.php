...
class Sensor_model extends CI_Model
{
  ...
  public function __construct()
    ...
    public function chartBarangMasuk($bulan)
    {
        ...
        return count($this->db->get('brgmsk_snsr')->result_array());
    }
    ...
    public function chartBarangKeluar($bulan)
    {
        ...
        return count($this->db->get('brgklr_snsr')->result_array());
    }
     ...
     public function get_barcode_by_id($id = 0)
    {
        if ($id === 0)
        {
            $query = $this->db->get('master_sensor');
            return $query->result_array();
        }
 
        $query = $this->db->get_where('master_sensor', array('kode_brg' => $id));
    ...
    public function delete_brg($id)
    {
        ...
        return $this->db->delete('master_sensor');
    }
    ...
    public function get_brgmsk_by_id($id = 0)
    {
        if ($id === 0)
        {
            $query = $this->db->get('brgmsk_snsr');
            return $query->result_array();
        }
 
        $query = $this->db->get_where('brgmsk_snsr', array('id_barang_masuk' => $id));
        return $query->row_array();
    }
    ...
    public function delete_brgmsk($id)
    {
        ...
        return $this->db->delete('brgmsk_snsr');
    }
    ...
    public function get_brgklr_by_id($id = 0)
    {
        if ($id === 0)
        {
            $query = $this->db->get('brgklr_snsr');
            return $query->result_array();
        }
 
        $query = $this->db->get_where('brgklr_snsr', array('id_barang_keluar' => $id));
        return $query->row_array();
    }
    ...
    public function delete_brgklr($id)
    {
        ...
        return $this->db->delete('brgklr_snsr');
    }
    ...
    public function getBarang()
    {
        ...
        return $this->db->get('master_sensor ')->result_array();
    }
    ...
    public function getBarangMasuk($limit = null, $kode_brg = null, $range = null)
    {
        ...
        $this->db->join('master_sensor b', 'bm.barang_id = b.kode_brg');
        ...
        return $this->db->get('brgmsk_snsr bm')->result_array();
    }
    ...
    public function getBarangKeluar($limit = null, $kode_brg = null, $range = null)
    {
        ...
        $this->db->join('master_sensor b', 'bk.barang_id = b.kode_brg');
        ...
        return $this->db->get('brgklr_snsr bk')->result_array();
    }
...
public function cekStok($id)
    {
        ...
        return $this->db->get('master_sensor ', ['kode_brg' => $id])->row_array();
    }
