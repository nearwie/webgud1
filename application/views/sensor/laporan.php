													...
													<div>
														<div class="card-body">
											                ...
											                <div class="row form-group">
											                    <label class="col-md-3 text-md-right" for="transaksi">Laporan Transaksi Sensor</label>
											                    <div class="col-md-9">
											                        <div class="custom-control custom-radio">
											                            <input value="brgmsk_snsr" type="radio" id="brgmsk_snsr" name="transaksi" class="custom-control-input">
											                            <label class="custom-control-label" for="brgmsk_snsr">Barang Masuk</label>
											                        </div>
											                        <div class="custom-control custom-radio">
											                            <input value="brgklr_snsr" type="radio" id="brgklr_snsr" name="transaksi" class="custom-control-input">
											                            <label class="custom-control-label" for="brgklr_snsr">Barang Keluar</label>
											                        </div>
