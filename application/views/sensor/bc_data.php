													...
													<div>
														<div class="card-body">
											                ...
											                <div class="row form-group">
											                    <label class="col-md-3 text-md-right" for="transaksi"><?= $btr['nama_brg'];?></label>
											                    <div class="col-md-9">
											                ...
											                <div class="row form-group">
											                    <div class="col-lg-2 offset-lg-3 pull-right">
											                    	<a class="white"  href="<?php echo base_url('baterai/cetakbarcode/'.$btr['kode_brg']) ?>" class="badge badge-success">
