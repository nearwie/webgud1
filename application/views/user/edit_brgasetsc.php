				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?= base_url ('detailbrg') ;?>">Persediaan Aset SU-CA</a>
							</li>
							...
							<div class="col-xs-12">
								...
								<div class="form-horizontal">
									 <?= $this->session->flashdata('pesan'); ?>
                						<?= form_open('', [], ['stok' => 0, 'kode_brg' => $barangsc['kode_brg']]); ?>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<input value="<?= set_value('nama_brg', $barangsc['nama_brg']); ?>" name="nama_brg" id="nama_brg" type="text" class="form-control" placeholder="Nama Barang...">
								...
								<div class="row form-group">
                    				...
                    				<label class="col-sm-3 control-label no-padding-right" for="type_id">Kategori Aset</label>
									 ...
									 <div class="form-group">
										...
										<label class="col-sm-3 control-label no-padding-right"  for="no_seri">Serial Number </label>
				                   			<div class="col-md-3">
				                        		<input value="<?= set_value('no_seri', $barangsc['no_seri']); ?>" name="no_seri" id="no_seri" type="text" class="form-control" placeholder="Nomor Serial...">
										...
										<label class="col-sm-3 control-label no-padding-right"  for="stok">Stok </label>
				                   			<div class="col-md-3">
				                        		 <input readonly value="<?php echo $barangsc['stok'] ?>" name="stok" id="stok"  class="form-control" >
									...
									<div class="form-group">
										...
										<label class="col-sm-3 control-label no-padding-right"  for="gambar">Gambar</label>
				                   			<div class="col-md-3">
				                   				<img src="<?= base_url('assets/img/upload/'). $barangsc ['gambar'];?>" class="img-thumbnail">
