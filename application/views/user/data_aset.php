													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="red" href="<?php echo base_url('dataasetsc/delete/'.$a['kode_brg']) ?>"  onclick="javascript: return confirm('Apakah yakin menghapus')" class="badge badge-danger">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="<?php echo base_url('dataasetsc/delete/'.$a['kode_brg']) ?>"  class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
