						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="form-horizontal">
                					...
                					<form method="post" action="<?= base_url('dataasetsc/tambah')?>" enctype="multipart/form-data">
									<!-- #section:elements.form -->
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="kode_brg"> Kode Aset </label>
								...
								<div class="row form-group">
                    				...
                    				<label class="col-sm-3 control-label no-padding-right" for="type_id">Kategori Aset</label>
                   						 <div class="col-md-7">
                    						    <div class="input-group">
                            						...
                            						<span >	
                               					 <a class="btn btn-success" href="<?= base_url('type/add_type'); ?>"><i class="fa fa-plus"></i></a>
                            				</span>
                        				</div>
										...
										<label class="col-sm-3 control-label no-padding-right"  for="merk">Merk</label>
				                   			<div class="col-md-3">
				                        		<input  name="merk" id="merk" type="text" class="form-control" placeholder="Merk...">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right"  for="no_seri">S/N</label>
				                   			<div class="col-md-3">
				                        		<input  name="no_seri" id="no_seri" type="text" class="form-control" placeholder="Nomor Serial...">
