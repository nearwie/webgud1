							...
							<div class="col-xs-12">
								...
								<div class="form-horizontal">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											 <input type="hidden" name="id_satuan" value="<?php echo $a['id_satuan'] ?>">
                        				<input value="<?php echo $a['nama_satuan'] ?>" name="nama_satuan" id="nama_satuan" type="text" class="form-control" placeholder="Nama Satuan...">
