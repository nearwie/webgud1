							...
							<div class="col-xs-12">
								...
								<div class="form-horizontal">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input   name="id_sta" id="id_sta" type="text" class="col-xs-10 col-sm-2" placeholder="STA ID...">
											<?= form_error('id_sta', '<small class="text-danger">', '</small>'); ?>
										</div>
									</div>

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="nama_pos">Pos Hujan</label>

										<div class="col-sm-3">
											<input  name="nama_pos" id="nama_pos" type="text" class="form-control" placeholder="Nama Pos Hujan...">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right"  for="wilayah">Kab/Kota </label>
				                   			<div class="col-md-3">
				                        		<input  name="wilayah" id="wilayah" type="text" class="form-control" placeholder="Kab/Kota...">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right"  for="pengamat">Pengamat </label>
				                   			<div class="col-md-3">
				                        		<input  name="pengamat" id="pengamat" type="text" class="form-control" placeholder="Pengamat...">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right"  for="koor">Koordinator </label>
				                   			<div class="col-md-3">
				                        		<input name="koor" id="koor" type="text" class="form-control" placeholder="Koordinator...">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right"  for="keterangan">Keterangan </label>
				                   			<div class="col-md-3">
				                        		<input name="keterangan" id="keterangan" type="text" class="form-control" placeholder="Keterangan...">
