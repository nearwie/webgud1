						...
						<!-- /section:settings.box -->
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="col-auto">
							                <a href="<?= base_url('addbrgkeluar') ;?>" class="btn btn-success">
							                    <span class="icon">
													...
													<?php
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="red" href="<?= base_url('barangkeluar/delete/') . $bk['id_barang_keluar'] ?>" onclick="javascript: return confirm('Apakah yakin menghapus')">
