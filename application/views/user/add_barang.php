						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row form-group">
                    				...
                    				<label class="col-sm-3 control-label no-padding-right" for="jenis_id">Jenis Barang</label>
                   						 <div class="col-md-9">
                    				...
                    				<label class="col-sm-3 control-label no-padding-right" for="satuan_id">Satuan Barang</label>
                   						 <div class="col-md-9">
                    						    <div class="input-group">
