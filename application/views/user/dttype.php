						...
						<div class="row">
									<div class="col-xs-12">
          							...
          							<?= $this->session->flashdata('pesan'); ?>
										...
										<h3 class="header smaller lighter blue">Data Aset</h3>
										<div class="pull-right tableTools-container"></div>
										</div>
										<div class="col-auto">
							                <a href="<?= base_url('type/add_type'); ?>" class="btn btn-success">
							                    <span class="icon">
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="<?= base_url('type/edit_type/') . $j['id_type'] ?>" class="badge badge-success">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red" onclick="return confirm('Yakin ingin hapus?')" href="<?= base_url('type/delete/') . $j['id_type'] ?>" class="badge badge-danger">
