				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?= base_url ('dataaset') ;?>">Persediaan Aset</a>
							</li>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											  <input type="hidden" name="id_type" value="<?php echo $a['id_type'] ?>">
                       						 <input value="<?php echo $a['nama_type'] ?>" name="nama_type" id="nama_type" type="text" class="form-control" placeholder="Nama type...">
