				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?= base_url('C_btrkeluar') ;?>">Historis Stok Keluar</a>
							</li>
								...
								<div class="form-horizontal">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
		                                    ...
		                                    <option value="<?= $b['kode_brg'] ?>">kode:<?= $b['kode_brg'] . ' - ' . $b['nama_brg']. ' | ' . $b['merk']. ' - ' . $b['model'] ?></option>
		                                <?php endforeach; ?>				
											</select>									
										</div>
...
<![endif]-->
 <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
        ...
        let jumlah = hal == 'C_btrmasuk' ? $('#jumlah_masuk') : $('#jumlah_keluar');

        $(document).on('change', '#barang_id', function() {
            let url = '<?= base_url('baterai/getstok/'); ?>' + this.value;
