													...
													<div>
														<div class="card-body">
											                ...
											                <div class="row form-group">
											                    <label class="col-md-3 text-md-right" for="transaksi">Laporan Transaksi Baterai</label>
											                    <div class="col-md-9">
											                        <div class="custom-control custom-radio">
											                            <input value="brgmsk_btr" type="radio" id="brgmsk_btr" name="transaksi" class="custom-control-input">
											                            <label class="custom-control-label" for="brgmsk_btr">Barang Masuk</label>
											                        </div>
											                        <div class="custom-control custom-radio">
											                            <input value="brgklr_btr" type="radio" id="brgklr_btr" name="transaksi" class="custom-control-input">
											                            <label class="custom-control-label" for="brgklr_btr">Barang Keluar</label>
											                        </div>
