													...
													<div>
														<div class="card-body">
											                ...
											                <div class="row form-group">
											                    <label class="col-md-3 text-md-right" for="transaksi">Laporan Transaksi Logger</label>
											                    <div class="col-md-9">
											                        <div class="custom-control custom-radio">
											                            <input value="brgmsk_log" type="radio" id="brgmsk_log" name="transaksi" class="custom-control-input">
											                            <label class="custom-control-label" for="brgmsk_log">Barang Masuk</label>
											                        </div>
											                        <div class="custom-control custom-radio">
											                            <input value="brgklr_log" type="radio" id="brgklr_log" name="transaksi" class="custom-control-input">
											                            <label class="custom-control-label" for="brgklr_log">Barang Keluar</label>
											                        </div>
