				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?= base_url ('logger') ;?>">Suku Cadang</a>
							</li>
									...
									<div class="col-xs-12">
          							...
          							<?= $this->session->flashdata('pesan'); ?>
										...
										<div class="col-auto">
							                ...
							                <p>
							                <a href="<?= base_url('logger/tambah'); ?>"><b>
											...
											<a href="<?= base_url('C_loglaporan'); ?>"><b>
													...
													<tr>
														...
														<td>
															...
															<td ><?= $a['kode_brg'];?>
																...
																<a class="green" href="<?php echo base_url('logger/barcode/'.$a['kode_brg']) ?>" class="badge badge-success">
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="<?php echo base_url('logger/edit/'.$a['kode_brg']) ?>" class="badge badge-success">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red" href="<?php echo base_url('logger/delete/'.$a['kode_brg']) ?>" onclick="javascript: return confirm('Apakah yakin menghapus')" class="badge badge-danger">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="<?php echo base_url('logger/edit/'.$a['kode_brg']) ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
																		...
																		<li>
																			<a href="<?php echo base_url('logger/delete/'.$a['kode_brg']) ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
