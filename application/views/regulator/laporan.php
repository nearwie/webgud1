													...
													<div>
														<div class="card-body">
											                ...
											                <div class="row form-group">
											                    <label class="col-md-3 text-md-right" for="transaksi">Laporan Transaksi Regulator</label>
											                    <div class="col-md-9">
											                        <div class="custom-control custom-radio">
											                            <input value="brg_msk" type="radio" id="brg_msk" name="transaksi" class="custom-control-input">
											                            <label class="custom-control-label" for="brg_msk">Barang Masuk</label>
											                        </div>
											                        <div class="custom-control custom-radio">
											                            <input value="brg_klr" type="radio" id="brg_klr" name="transaksi" class="custom-control-input">
											                            <label class="custom-control-label" for="brg_klr">Barang Keluar</label>
											                        </div>
