							...
							<div class="col-xs-12">
								...
								<div class="form-horizontal">
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<input value="<?= set_value('tahun', $barang['tahun']); ?>" name="tahun" id="tahun" type="text" class="form-control" >
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<input value="<?= set_value('merk', $barang['merk']); ?>" name="merk" id="merk" type="text" class="form-control" >
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<input value="<?= set_value('model', $barang['model']); ?>" name="model" id="model" type="text" class="form-control" >
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<input value="<?= set_value('ket', $barang['ket']); ?>" name="ket" id="ket" type="text" class="form-control" >
