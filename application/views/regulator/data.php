				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?= base_url ('regulator') ;?>">Suku Cadang</a>
							</li>
							<li class="active">Data Regulator</li>
						</ul><!-- /.breadcrumb -->
									...
									<div class="col-xs-12">
          							...
          							<?= $this->session->flashdata('pesan'); ?>
										...
										<div class="widget-box transparent">
											<div class="widget-header widget-header-large">
												...
												<div class="widget-toolbar hidden-480">
													<a href="<?= base_url('C_reglaporan/createpdf')?>">
										...
										<div class="col-auto">
							                ...
							                <p>
							                <a href="<?= base_url('regulator/tambah'); ?>"><b>
											...
											<a href="<?= base_url('C_reglaporan'); ?>"><b>
													...
													<tr>
														...
														<td>
															...
															<td ><?= $a['kode_brg'];?>
																...
																<a class="green" href="<?php echo base_url('regulator/barcode/'.$a['kode_brg']) ?>" class="badge badge-success">
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="<?php echo base_url('regulator/edit/'.$a['kode_brg']) ?>" class="badge badge-success">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red" href="<?php echo base_url('regulator/delete/'.$a['kode_brg']) ?>" onclick="javascript: return confirm('Apakah yakin menghapus')" class="badge badge-danger">
