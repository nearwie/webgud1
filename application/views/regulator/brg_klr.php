						...
						<!-- /section:settings.box -->
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<h3 class="header smaller lighter blue">Barang Keluar (Regulator)</h3>
										<div class="pull-right tableTools-container"></div>
										</div>
										<div class="col-auto">
							                <a href="<?= base_url('C_regKeluar/add_stokklr'); ?>" class="btn btn-success">
							                    <span class="icon">
									               ...
									               <?php $i = 1;  
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="red" href="<?= base_url('C_regkeluar/delete/') . $bk['id_barang_keluar'] ?>" onclick="javascript: return confirm('Apakah yakin menghapus')">
