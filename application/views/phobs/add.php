				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?= base_url('phobs') ;?>">Data Penakar Hujan OBS</a>
							</li>
							...
							<div class="col-xs-12">
								...
								<div class="form-horizontal">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="kode_brg"> Kode Barang </label>

										<div class="col-sm-9">
											<input readonly value="<?= set_value('kode_brg', $kode_brg); ?>" name="kode_brg" id="kode_brg" type="text" class="col-xs-10 col-sm-2" >
											<?= form_error('kode_brg', '<small class="text-danger">', '</small>'); ?>
										</div>
									</div>

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="nama_brg">Nama Barang</label>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="tahun">Tahun Datang</label>

										<div class="col-sm-3">
											<input value="<?= set_value('tahun'); ?>" name="tahun" id="tahun" type="text" class="form-control" placeholder="Tahun datang...">
								...
								<div class="form-group">
										...
										<div class="col-sm-3">
											<input value="<?= set_value('model'); ?>" name="model" id="model" type="text" class="form-control" placeholder="Model...">
                        				<?= form_error('model', '<small class="text-danger">', '</small>'); ?>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="ket">Lokasi</label>

										<div class="col-sm-3">
											<input value="<?= set_value('ket'); ?>" name="ket" id="ket" type="text" class="form-control" placeholder="Lokasi...">
