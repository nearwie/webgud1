...
<!--<div class="container-fluid"> -->
    <center><h5>PERSEDIAAN SUKU CADANG PENAKAR HUJAN OBS</h5>
        ...
        <thead>
            <tr>
                    <th width="5%" scope="col" style="text-align: center; font-size: 14px" >No</th>
                      ...
                      <th width="10%" scope="col" style="text-align: center; font-size: 14px">Model</th>
        ...
        <tbody>
            <?php $i = 1;  ?>
                    ...
                    <tr>
                      ...
                      <td style="text-align: center; font-size: 12px"><?= $a['model'];?></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td align="center" >&nbsp;</td>
                        <td align="center" style="font-size: 14px"><b>Wahyu Nurhuda, S.Tr</b></td>
                    </tr>
                    <tr>
