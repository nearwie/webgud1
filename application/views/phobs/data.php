				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?= base_url ('phobs') ;?>">Suku Cadang</a>
							</li>
							<li class="active">Data Penakar Hujan OBS</li>
						</ul><!-- /.breadcrumb -->
									...
									<div class="col-xs-12">
          							...
          							<?= $this->session->flashdata('pesan'); ?>
										...
										<div class="widget-box transparent">
											<div class="widget-header widget-header-large">
												...
												<div class="widget-toolbar hidden-480">
													<a href="<?= base_url('C_obslaporan/createpdf')?>">
										...
										<div class="col-auto">
							                ...
							                <p>
							                <a href="<?= base_url('phobs/tambah'); ?>"><b>
											...
											<a href="<?= base_url('C_obslaporan'); ?>"><b>
										...
										<div class="table-header">
											Detail Barang (Penakar Hujan OBS)
										</div>
													...
													<tr>
														...
														<td>
															...
															<td ><?= $a['kode_brg'];?>
																...
																<a class="green" href="<?php echo base_url('phobs/barcode/'.$a['kode_brg']) ?>" class="badge badge-success">
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="<?php echo base_url('phobs/edit/'.$a['kode_brg']) ?>" class="badge badge-success">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red" href="<?php echo base_url('phobs/delete/'.$a['kode_brg']) ?>" onclick="javascript: return confirm('Apakah yakin menghapus')" class="badge badge-danger">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="<?php echo base_url('phobs/edit/'.$a['kode_brg']) ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
																		...
																		<li>
																			<a href="<?php echo base_url('phobs/delete/'.$a['kode_brg']) ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
