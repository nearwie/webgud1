													...
													<div>
														<div class="card-body">
											                ...
											                <div class="row form-group">
											                    <label class="col-md-3 text-md-right" for="transaksi">Laporan Transaksi PH OBS</label>
											                    <div class="col-md-9">
											                        <div class="custom-control custom-radio">
											                            <input value="brgmsk_phujan" type="radio" id="brgmsk_phujan" name="transaksi" class="custom-control-input">
											                            <label class="custom-control-label" for="brgmsk_phujan">Barang Masuk</label>
											                        </div>
											                        <div class="custom-control custom-radio">
											                            <input value="brgklr_phujan" type="radio" id="brgklr_phujan" name="transaksi" class="custom-control-input">
											                            <label class="custom-control-label" for="brgklr_phujan">Barang Keluar</label>
											                        </div>
