				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?= base_url('C_obskeluar') ;?>">Historis Stok Keluar</a>
							</li>
							...
							<div class="col-xs-12">
								...
								<div class="form-horizontal">
									<?= $this->session->flashdata('pesan'); ?>
		                				...
		                				<?= form_open('', [], ['id_barang_keluar' => $id_barang_keluar, 'user_id' => $user['id']]); ?>
									<!-- #section:elements.form -->
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="id_barang_keluar"> ID Transaksi BK </label>

										<div class="col-sm-9">
											<input value="<?= $id_barang_keluar; ?>" type="text" readonly="readonly" class="col-xs-10 col-sm-5" >
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="barang_id"> Nama BK </label>
										...
										<div class="col-sm-4">
		                                    ...
		                                    <option value="<?= $b['kode_brg'] ?>">kode:<?= $b['kode_brg'] . ' - ' . $b['nama_brg']. ' | ' . $b['tahun']. ' - ' . $b['model'] ?></option>
		                                <?php endforeach; ?>				
											</select>									
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input readonly="" type="text" class="col-xs-10 col-sm-5" id="model" >
											<span class="help-inline col-xs-12 col-sm-7">
												<label class="middle">
...
<![endif]-->
 <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
        ...
        let jumlah = hal == 'C_obsmasuk' ? $('#jumlah_masuk') : $('#jumlah_keluar');

        $(document).on('change', '#barang_id', function() {
            let url = '<?= base_url('phobs/getstok/'); ?>' + this.value;
